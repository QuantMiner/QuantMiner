...
public class OptimiseurRecuitSimule extends OptimiseurRegle {

    AlgoRecuitSimule m_algoRecuitSimule = null;
    ParametresStandardsQuantitatifs m_parametresReglesQuantitatives = null;
    ParametresRecuitSimule m_parametresAlgo = null;
    ...
    public void DefinirContexteResolution(ContexteResolution contexteResolution) {
        ...
        m_algoRecuitSimule = new AlgoRecuitSimule(super.m_contexteResolution.m_gestionnaireBD, m_parametresAlgo.m_iNombreIterations, m_parametresAlgo.m_iNombreSolutionsParalleles);
