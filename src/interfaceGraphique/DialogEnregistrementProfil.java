...
public class DialogEnregistrementProfil extends javax.swing.JDialog { //profile--> save
    
    int m_iPanneauCourant = FenetrePrincipale.PANNEAU_AUCUN;
    ...
    public DialogEnregistrementProfil(int iPanneauCourant, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        jCheckBoxPreChargement.setEnabled( (iPanneauCourant==FenetrePrincipale.PANNEAU_PRE_CHARGEMENT_BD) || (iPanneauCourant==FenetrePrincipale.PANNEAU_PRE_EXTRACION) || (iPanneauCourant==FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE) );
        jCheckBoxPreExtraction.setEnabled( (iPanneauCourant==FenetrePrincipale.PANNEAU_PRE_EXTRACION) || (iPanneauCourant==FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE) );
        jCheckBoxApriori.setEnabled( iPanneauCourant == FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE );
        jCheckBoxGenetique.setEnabled( iPanneauCourant == FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE );
    ...
    private void jButtonAideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAideActionPerformed
        DialogFenetreAide dialogAide = new DialogFenetreAide(ENV.REPERTOIRE_AIDE+"profils.htm", null, true);
        dialogAide.show();
    ...
    public static void main(String args[]) {
        new DialogEnregistrementProfil(0, new javax.swing.JFrame(), true).show();
    }
