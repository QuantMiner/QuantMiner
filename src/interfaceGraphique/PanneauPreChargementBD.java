...
public class PanneauPreChargementBD extends PanneauBaseAssistant {//step 1 
    ...
    public PanneauPreChargementBD(ContexteResolution contexteResolution) {
        ...
        super.DefinirPanneauPrecedent(FenetrePrincipale.PANNEAU_AUCUN);  //since this is the first step's panel, no previous panel exist
        super.DefinirPanneauSuivant(FenetrePrincipale.PANNEAU_PRE_EXTRACION); //next panel is the second step panel
