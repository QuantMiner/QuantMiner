...
public class PanneauConfigTechnique extends PanneauBaseAssistant { //step 3 parameter configuration
    ...
    PanneauParamBase m_panneauParamsRegles = null; //  Rule parameter Panel 
    PanneauParamBase m_panneauParamsTech = null;   // Technique parameter panel
    ...
    public PanneauConfigTechnique(ContexteResolution contexteResolution) {
        ...
        super.DefinirPanneauPrecedent(FenetrePrincipale.PANNEAU_PRE_EXTRACION);  //previous step is step2
        super.DefinirPanneauSuivant(FenetrePrincipale.PANNEAU_TECH_GENERIQUE);   //next step is step4
    ...
    private void jButtonInfoTechniqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInfoTechniqueActionPerformed
        ...
        if (sNomFichierAide != null) {
            dialogAide = new DialogFenetreAide(ENV.REPERTOIRE_AIDE+sNomFichierAide, null, true);
            dialogAide.show();
        }
    ...
    public void ActiverPanneauAssistant(int iConteneur, int iPanneau) {
        ...
        PanneauParamBase panneauAncien = null;
        PanneauParamBase panneauActive = null;
        ...
        if (iConteneur == CONTENEUR_PARAM_REGLES) { //if it is rule parameter panel
            ...
            switch (iPanneau) {
                ...
                case PANNEAU_PARAM_REGLES_STANDARD : //show standard rule parameter panel
                    panneauActive = (PanneauParamRegles)( new PanneauParamRegles(m_contexteResolution) );
                    break;
                    
                    
                case PANNEAU_PARAM_REGLES_QUANTITATIVES_STANDARD :  //show quantitative standard rule parameter panel
                    panneauActive = (PanneauParamReglesQuantitatives)( new PanneauParamReglesQuantitatives(m_contexteResolution) );
                    break;                    
            ...
            switch (iPanneau) {
                ...
                case PANNEAU_PARAM_TECH_GENETIQUE :  //generic algorithm
                    panneauActive = (PanneauParamGenetique)( new PanneauParamGenetique(m_contexteResolution) );
                    break;

                case PANNEAU_PARAM_TECH_RECUIT :  //simulated annealing algorithm
                    panneauActive = (PanneauParamRecuitSimule)( new PanneauParamRecuitSimule(m_contexteResolution) );
                    break;
                    
                case PANNEAU_PARAM_TECH_CHARGEMENT : //load a precomputed rule file
                    panneauActive = (PanneauParamChargement)( new PanneauParamChargement(m_contexteResolution) );
                    break;                    
