...
public class PanneauParamGenetique extends PanneauParamBase {//step 3 technique parameters
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jTextTauxCroisement.setInputVerifier(new UtilitairesInterface.VerifieurTextFieldIntervalleFloat(0.0f, 100.0f));
        add(jTextTauxCroisement);
        jTextTauxCroisement.setBounds(330, 80, 60, 20);

        jTextTauxMutation.setText("jTextField1");
        jTextTauxMutation.setInputVerifier(new UtilitairesInterface.VerifieurTextFieldIntervalleFloat(0.0f, 100.0f));
