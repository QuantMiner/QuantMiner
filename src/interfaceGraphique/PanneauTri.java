...
public class PanneauTri extends javax.swing.JPanel { //step 5 the second/middle panel
    ...
    private void initComponents() {
        ...
        jTextFieldInteret.setInputVerifier(new UtilitairesInterface.VerifieurTextFieldIntervalleFloat(0.0f, 100.0f));
    ...
    private void InitialiserContenuPanneau() {
        ...
        for (iIndiceRegle=0; iIndiceRegle<iNombreRegles; iIndiceRegle++) {
            regle = (RegleAssociation)m_contexteResolution.m_listeRegles.get(iIndiceRegle);
