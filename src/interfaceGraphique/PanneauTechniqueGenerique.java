...
public class PanneauTechniqueGenerique extends PanneauBaseAssistant { //step 4
    ...
    class IndicateurCalculReglesGenerique extends TesteurRegles.IndicateurCalculRegles {
        ...
        public void IndiquerFinCalcul() {
            DialogFinCalculRegles fenetreFinCalcul = null;

            if (!ENV.AVERTIR_FIN_CALCUL) //AVERTIR notice finishing calculation
                return;
            
            fenetreFinCalcul = new DialogFinCalculRegles(m_panneauParent.m_contexteResolution.m_fenetreProprietaire, true);
    ...
    public PanneauTechniqueGenerique(ContexteResolution contexteResolution) {
        ...
        super.DefinirPanneauPrecedent(FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE); //previous step is step 3
        super.DefinirPanneauSuivant(FenetrePrincipale.PANNEAU_RESULTATS);          //next step is step 5
