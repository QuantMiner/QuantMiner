...
public class JIndicateurEtape extends JPanel { //indicator from step 1 to step 5 the rectangular on top of each step
    ...
    public JIndicateurEtape(int iNumero, String sIntitule) {
    ...
    private void jButtonAideActionPerformed(java.awt.event.ActionEvent evt) {
        DialogFenetreAide dialogAide = null;
        
        if (m_sFichierAide != null) {
            dialogAide = new DialogFenetreAide(m_sFichierAide, null, true);
            dialogAide.show();
        }
    }
