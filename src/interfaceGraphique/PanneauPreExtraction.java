...
public class PanneauPreExtraction extends PanneauBaseAssistant {
    ...
    public PanneauPreExtraction(ResolutionContext contexteResolution) {//step 2
        ...
        super.DefinirPanneauPrecedent(FenetrePrincipale.PANNEAU_PRE_CHARGEMENT_BD);  //previous step is step 1
        super.DefinirPanneauSuivant(FenetrePrincipale.PANNEAU_CONFIG_TECHNIQUE);     //next step is algorithm chosen and set parameters
