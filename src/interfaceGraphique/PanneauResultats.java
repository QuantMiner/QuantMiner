...
public class PanneauResultats extends PanneauBaseAssistant { //step 5
    ...
    private class ResultatsEnregistreurGraphiqueRegle implements ContexteResolution.EnregistreurGraphiqueRegle { 
        ...
        public String EnregistrerRegle(RegleAssociation regle, int iIndiceRegle) {  //record rules
            File fichier = null;
    ...
    public PanneauResultats(ContexteResolution contexteResolution) {
        ...
        //the middle part
        m_panneauTri = new PanneauTri(this, super.m_contexteResolution); 
        m_panneauTri.setBorder(new javax.swing.border.EtchedBorder());
        add(m_panneauTri);
        
        //the third part
        m_afficheurRegles = new AfficheurRegles(super.m_contexteResolution);
        ...
        switch (m_contexteResolution.m_iTechniqueResolution) {
            ...
            default:
                super.DefinirPanneauPrecedent(FenetrePrincipale.PANNEAU_AUCUN);
        }        
        
        super.DefinirPanneauSuivant(FenetrePrincipale.PANNEAU_AUCUN);
    ...
    private void jButtonVoirContexteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVoirContexteActionPerformed
        DialogFenetreInfoHTML dialogContexte = null;
        String sInfosContexte = null;
        
        sInfosContexte = this.m_contexteResolution.ObtenirInfosContexte(true);
        dialogContexte = new DialogFenetreInfoHTML("Information on the context of extraction of rules", sInfosContexte, this.m_contexteResolution.m_fenetreProprietaire, true);
        dialogContexte.show();
    ...
    private void jButtonCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCopyActionPerformed
        ...
        RegleAssociation regleCourante = null;
    ...
    private void jButtonSauverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSauverActionPerformed
        ...
        DialogChoixEnregistrementFichier fenetreTypeEnregistrement = null;
        DialogChoixEnregistrementFichier.DialogChoixEnregistrementFichier_Donnees donnees = null;
        ResultatsEnregistreurGraphiqueRegle enregistreurGraphique = null;
        
        //save a list of rules, dialog
        fenetreTypeEnregistrement = new DialogChoixEnregistrementFichier(m_contexteResolution, m_contexteResolution.m_fenetreProprietaire, true);
        donnees = fenetreTypeEnregistrement.LierStructureDonnees();
        fenetreTypeEnregistrement.show();
        
        //cancel
        if (donnees.m_iTypeEnregistrement == DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_ANNULER)
            return;
       ...
       if (  (donnees.m_iTypeEnregistrement == DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_HTML_TEXTE)
            ||(donnees.m_iTypeEnregistrement == DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_HTML_GRAPHIQUE)  )
            sFichierChoisi = UtilitairesInterface.DialogSauvegardeFichier(this, ENV.REPERTOIRE_RESULTATS, "HTML File", "htm");//"Fichiers HTML", "htm");
       //save as qmr file
       else if (donnees.m_iTypeEnregistrement == DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_BINAIRE)
            sFichierChoisi = UtilitairesInterface.DialogSauvegardeFichier(this, ENV.REPERTOIRE_REGLES_QMR, "QuantMiner File", "qmr");//"Fichiers QuantMiner", "qmr");

       //save as csv file
       else 
    	   sFichierChoisi = UtilitairesInterface.DialogSauvegardeFichier(this, ENV.REPERTOIRE_RESULTATS, "CSV File", "csv");
       
        if (sFichierChoisi != null) {

            switch (donnees.m_iTypeEnregistrement) {
                case DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_HTML_TEXTE :
                ...
                case DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_BINAIRE :
                    ...
                    break;
                case DialogChoixEnregistrementFichier.TYPE_ENREGISTREMENT_CSV :
    ...
    private AfficheurRegles m_afficheurRegles = null;
    
    //The middle panel
    private PanneauTri m_panneauTri = null;
    ...
    public void MettreAJourListeRegles() {
        ...
        for (iIndiceRegle=0; iIndiceRegle<m_iNombreReglesTotales; iIndiceRegle++) {
            regle = (RegleAssociation)super.m_contexteResolution.m_listeRegles.get(iIndiceRegle);
        ...
        if (m_iNombreReglesRetenues > 0) {
            m_tReglesFiltrees = new RegleAssociation[1];
            m_tReglesFiltrees = (RegleAssociation [])(listeTempRegles.toArray(m_tReglesFiltrees));
 
        
            // Tri des r�gles :
            bTriDecroissant = m_panneauTri.EstTriDecroissant();
            switch ( m_panneauTri.ObtenirMethodeTri() ) {
                case PanneauTri.METHODE_TRI_SUPPORT:
                    comparateur = RegleAssociation.ObtenirComparateurSupport(bTriDecroissant);
                    break;
                case PanneauTri.METHODE_TRI_NOMBRE_ATTRIBUTS:
                    comparateur = RegleAssociation.ObtenirComparateurNombreAttributs(bTriDecroissant);
                    break;
                default :
                    comparateur = RegleAssociation.ObtenirComparateurConfiance(bTriDecroissant);
            }
    ...
    public RegleAssociation ObtenirRegleCourante() {
