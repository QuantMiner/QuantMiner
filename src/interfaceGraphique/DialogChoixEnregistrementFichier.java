...
public class DialogChoixEnregistrementFichier extends javax.swing.JDialog { //save result in a file
	...
	private void jButtonAideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAideActionPerformed
        DialogFenetreAide dialogAide = new DialogFenetreAide(ENV.REPERTOIRE_AIDE+"format_regles.htm", null, true);
        dialogAide.show();
	...
	public static void main(String args[]) {
        new DialogChoixEnregistrementFichier(null, new javax.swing.JFrame(), true).show();
    }
