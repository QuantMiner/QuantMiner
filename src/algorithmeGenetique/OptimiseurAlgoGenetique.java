 ...
 */
package src.algorithmeGenetique;
...
public class OptimiseurAlgoGenetique extends OptimiseurRegle {
    
    AlgoGenetique m_algoGenetique = null;
    ParametresStandardsQuantitatifs m_parametresReglesQuantitatives = null;
    ParametresAlgoGenetique m_parametresAlgo = null;
    ...
    public OptimiseurAlgoGenetique() {
    ...
    public void DefinirContexteResolution(ContexteResolution contexteResolution) {
        ...
        m_algoGenetique = new AlgoGenetique(m_parametresAlgo.m_iTaillePopulation, super.m_contexteResolution.m_gestionnaireBD);
