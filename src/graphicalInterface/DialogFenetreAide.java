...
public class DialogFenetreAide extends javax.swing.JDialog implements HyperlinkListener { //helper
    
    private String m_sPageCourante = null;
    
    
    /** Creates new form DialogFenetreAide */
    public DialogFenetreAide(String sFichierAide, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
	...
	public static void main(String args[]) {
        new DialogFenetreAide(null, new javax.swing.JFrame(), true).show();
    }
