...
public class FiltreChoixFichiers extends FileFilter {//filefilter means what kind of file to open
    ...
    public FiltreChoixFichiers(String sDescription) {//e.g. sDescription = "File DBase 4"
