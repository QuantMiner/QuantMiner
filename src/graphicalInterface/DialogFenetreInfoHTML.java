...
public class DialogFenetreInfoHTML extends javax.swing.JDialog implements HyperlinkListener {
    
   
    
    /** Creates new form DialogFenetreAide */
    public DialogFenetreInfoHTML(String sTitre, String sTexteHTMLAffiche, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        new DialogFenetreInfoHTML("", "", new javax.swing.JFrame(), true).show();
    }
