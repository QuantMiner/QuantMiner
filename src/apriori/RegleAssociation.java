...
public class RegleAssociation {
    ...
    public RegleAssociation(int iNombreItemsGauche, int iNombreItemsDroite, int iNombreDisjonctionsGauche, int iNombreDisjonctionsDroite) {
    ...
    // Construct de copie :
    public RegleAssociation(RegleAssociation regle) {
    ...
    // Construct de copie :
    public void CopierRegleAssociation(RegleAssociation regle) {
        int iIndiceItem = 0;
        Item item = null;
        ...
        if (regle != null) {
            ...
            for (iIndiceItem = 0; iIndiceItem < m_iNombreItemsGauche; iIndiceItem++) {
                ...
                if (item.m_iTypeItem == Item.ITEM_TYPE_QUANTITATIF)
                    this.m_tItemsGauche[iIndiceItem] = new ItemQuantitatif((ItemQuantitatif)item);
                else
            ...
            for (iIndiceItem=0; iIndiceItem<m_iNombreItemsDroite; iIndiceItem++) {
                ...
                if (item.m_iTypeItem == Item.ITEM_TYPE_QUANTITATIF)
                    this.m_tItemsDroite[iIndiceItem] = new ItemQuantitatif((ItemQuantitatif)item);
                else
    ...
    public static abstract class ComparateurRegles implements Comparator {
        ...
        public int compare(Object o1, Object o2) {
            ...
            iResultatComparaison = CompareRegles((RegleAssociation)o1, (RegleAssociation)o2);
        ...
        public abstract int CompareRegles(RegleAssociation regle1, RegleAssociation regle2);
    ...
    public static class ComparateurConfiance extends ComparateurRegles {
        ...
        public int CompareRegles(RegleAssociation regle1, RegleAssociation regle2) {
    ...
    public void EvaluerSiQualitative(ContexteResolution contexteResolution) {
        ...
        AprioriQuantitatif apriori = null;
        ...
        itemsGauche = new ItemQualitatif[ m_iNombreItemsGauche ];
        itemsTotaux = new ItemQualitatif[ m_iNombreItemsGauche+m_iNombreItemsDroite ];
        ...
        for (iIndiceItem=0; iIndiceItem<m_iNombreItemsGauche; iIndiceItem++) {
            ...
            if (item.m_iTypeItem == Item.ITEM_TYPE_QUALITATIF) {
                itemsGauche[iIndiceAjoutItemGauche] = (ItemQualitatif)item;
                itemsTotaux[iIndiceAjoutItemTotaux] = (ItemQualitatif)item;
         ...
         for (iIndiceItem = 0; iIndiceItem < iNombreItems; iIndiceItem++) {
             ...
             if (item.m_iTypeItem == Item.ITEM_TYPE_QUALITATIF) {
                 if (bPremierItemInscrit)
                     sRegle += "  AND  "; // "  ET  "
                 sRegle += ((ItemQualitatif)item).toString();
             ...
             for (iIndiceDisjonction = 0; iIndiceDisjonction < iNombreDisjonctions; iIndiceDisjonction++) {
                 ...
                 for (iIndiceItem = 0; iIndiceItem < iNombreItems; iIndiceItem++) {
                     ...
                     if (item.m_iTypeItem == Item.ITEM_TYPE_QUANTITATIF) {
                         if (bPremierItemInscrit)
                             sRegle += "  AND  "; //ET
                         sRegle += ((ItemQuantitatif)item).toString(iIndiceDisjonction);
                         bPremierItemInscrit = true;
                     }
                 }               
	...
	public Vector<Qualitative> leftQualiToArray() {
       ...
       //Firstly, write the qualitative items. if more than one exist, concatenate with AND
        for (iIndiceItem = 0; iIndiceItem < iNombreItems; iIndiceItem++) {
            item = tItemsRegle[iIndiceItem];
            if (item.m_iTypeItem == Item.ITEM_TYPE_QUALITATIF) {
            	array.add(((ItemQualitatif)item).getAttributeNameValue());
            }
        }    
        return array;
	}
	...
	public Vector<Vector<Quantitative>> leftQuantiToArray() {
        ...
        for (iIndiceDisjonction = 0; iIndiceDisjonction < iNombreDisjonctions; iIndiceDisjonction++) {
                ...
                for (iIndiceItem = 0; iIndiceItem < iNombreItems; iIndiceItem++) {
                    item = tItemsRegle[iIndiceItem];
                    if (item.m_iTypeItem == Item.ITEM_TYPE_QUANTITATIF) {
                    	temp.add(((ItemQuantitatif)item).getAttributeNameBoundary(iIndiceDisjonction));
                    }
                }    
