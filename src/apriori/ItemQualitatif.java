...
public class ItemQualitatif extends Item implements Comparable {
        
    long m_lIdentifieur = 0;
    public AttributQualitatif m_attributQual = null;   // Attribut de la BD dont est issu l'item
    public short m_iIndiceValeur = 0;                  // Indice de la valeur repr�sent�e par l'item parmi toutes celles de l'attribut 
       
        
    public ItemQualitatif(AttributQualitatif attributQual, short iIndiceValeur) {
        super();
    ...
    public int compareTo(Object o) {
        if (this.m_lIdentifieur > ((ItemQualitatif)o).m_lIdentifieur)
            return 1;
        else if (this.m_lIdentifieur < ((ItemQualitatif)o).m_lIdentifieur)
            return -1;
        else
            return 0;       
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null)
            ...
            return ( this.m_lIdentifieur == ((ItemQualitatif)obj).m_lIdentifieur );       
    }
