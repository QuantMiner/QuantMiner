...
public class ItemQuantitatif extends Item {
    
    public AttributQuantitatif m_attributQuant = null;   // Attribut de la BD dont est issu l'item
     ...
     */
    private void CreerItemQuantitatifMultiIntervalles(AttributQuantitatif attributQuant, float [] tBornes) {
    ...
    public ItemQuantitatif(AttributQuantitatif attributQuant, float [] tBornes) {
        super();
     ...
     */
    public ItemQuantitatif(AttributQuantitatif attributQuant, int iNombreDisjonctions) {
        super();
     ...
     * @param fBorneMax
     */
    public ItemQuantitatif(AttributQuantitatif attributQuant, float fBorneMin, float fBorneMax) {
        super();
    ...
    public ItemQuantitatif(ItemQuantitatif item) {
        super();
    ...
    public void CopierItemQuantitatif(ItemQuantitatif item) {
        int iIndiceDisjonction = 0;
