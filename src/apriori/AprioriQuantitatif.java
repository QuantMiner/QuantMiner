...
public class AprioriQuantitatif {
    ...
    public void ExecuterPretraitement(boolean bGenererItemSetsSingletons) {
        ...
        for (iIndiceAttributQual = 0; iIndiceAttributQual < iNombreAttributsQual; iIndiceAttributQual++) {
            ...
            attributQual = (AttributQualitatif)m_listeAttributsQual.get(iIndiceAttributQual);
    ...
    public boolean GenererNouvelleListeItemSets() {
        ...
        if (iIndiceListe == 0) {
            ...
            while (item != null) {
                ...
                item = (ItemQualitatif)(item.m_itemSuivant);
            }        
    ...
    */
    public ItemSet RechercherFrequent(ItemQualitatif [] items) {
     ...
     */
    public AttributQuantitatif ObtenirAttributQuantitatif(int iIndiceQuant) {
        if ( (iIndiceQuant>=0) && (iIndiceQuant<m_listeAttributsQuant.size()) )
            return (AttributQuantitatif)m_listeAttributsQuant.get(iIndiceQuant);
        else
            return null;
    }
     ...
     * @return quantitative attribute
     */
    public AttributQuantitatif ObtenirAttributQuantitatifDepuisNom(String sNomAttributQuant) {
        AttributQuantitatif attribut = null;
        ...
        while ( (attribut==null) && (iIndiceAttributQuant<iNombreAttributsQuant) ) {
            attribut = (AttributQuantitatif)m_listeAttributsQuant.get(iIndiceAttributQuant);
            if (attribut != null)
     ...
     */
    public AttributQualitatif ObtenirAttributQualitatifDepuisNom(String sNomAttributQual) {
        AttributQualitatif attribut = null;
        int iNombreAttributsQual = 0;
        int iIndiceAttributQual = 0;
        ...
        while ( (attribut==null) && (iIndiceAttributQual<iNombreAttributsQual) ) {
            attribut = (AttributQualitatif)m_listeAttributsQual.get(iIndiceAttributQual);
            if (attribut != null)
     ...
     */
    public ItemQualitatif ObtenirItem(AttributQualitatif attribut, short iIndiceValeur) {
        ItemQualitatif item = null;
