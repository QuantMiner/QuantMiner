...
public class GestionnaireBaseDeDonnees {
    ...
    public GestionnaireBaseDeDonnees(String sCheminFichier, String extension) {
    ...
    public void GestionnaireBaseDeDonneesDBF(String sCheminFichier){
        DBFLecteur lecteurDBF = null;
        DBFLecteur.DBFChamp champDBF = null;
        ...
        try {
            ...
            lecteurDBF = new DBFLecteur( m_sNomFichier ); 
        }
        catch (Exception e) {
            lecteurDBF = null;
