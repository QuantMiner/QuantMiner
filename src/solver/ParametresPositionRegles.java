...
public class ParametresPositionRegles {
    ...
    public class ParametresItemsQualitatifs {
        ...
        public ParametresItemsQualitatifs() {
            m_iTypePriseEnCompte = ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART;
    ...
    public ParametresPositionRegles(ContexteResolution contexteResolution, int iTypeParametrage) {
            ...
            if (colonne.m_sNomColonne != null)
            {
                    ...
                    if (!m_tableParametresItemsQualitatifs.containsKey(colonne.m_sNomColonne)) {
                        ...
                        for (iIndiceItem=0; iIndiceItem<tListeItems.length; iIndiceItem++)
                            if (tListeItems[iIndiceItem] != null) {
                                ...
                                if (m_iTypeParametrage == PARAMETRES_FILTRAGE_REGLES)
                                    bEnregistrerParametres = ( m_contexteResolution.ObtenirTypePrisEnCompteItem(colonne.m_sNomColonne, tListeItems[iIndiceItem]) != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART );
                                ...
                                if (bEnregistrerParametres) {
                                    ...
                                    if (m_iTypeParametrage == PARAMETRES_FILTRAGE_REGLES) {
                                        ...
                                        if ((tListeItems[iIndiceItem].trim()).equals(""))
                                            parametreItemDefaut.m_iTypePriseEnCompte = ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART;
                                        else
                                            parametreItemDefaut.m_iTypePriseEnCompte = ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART;//PRISE_EN_COMPTE_ITEM_2_COTES;
                ...
                // ATTRIBUTS QUANTITATIFS :
                    ...
                    if (!m_tableParametresAttributsQuantitatifs.containsKey(colonne.m_sNomColonne)) {
                        ...
                        bEnregistrerParametres = true;
                        if (m_iTypeParametrage == PARAMETRES_FILTRAGE_REGLES)
                            bEnregistrerParametres = ( m_contexteResolution.ObtenirTypePrisEnCompteAttribut(colonne.m_sNomColonne) != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART );
                        ...
                        if (bEnregistrerParametres) {
                            ...
                            if (m_iTypeParametrage == PARAMETRES_FILTRAGE_REGLES) {
                                ...
                                parametreQuantDefaut.m_iTypePriseEnCompte = ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART;
    ...
    public int ObtenirTypePrisEnCompteAttribut(String sAttribut) {
        ...
        iTypePosition = ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART;
            ...
            if (sousTable != null) {
                ...
                if (enumItems.hasMoreElements()) {
                    ...
                    if (!bTypesTousPareils)
                        iTypePosition = ContexteResolution.PRISE_EN_COMPTE_INDEFINI;
        ...
        // Attribut qualitatif :
            ...
            if (sousTable != null) {
                ...
                if (enumItems.hasMoreElements()) {
                    ...
                    while ( enumItems.hasMoreElements() ) {
                        parametreItemDefaut = (ParametresItemsQualitatifs)enumItems.nextElement();
                        if ( (!bPresenceObligatoire) || (parametreItemDefaut.m_iTypePriseEnCompte != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART) )
        ...
        while (enumAttributs.hasMoreElements()) {
             ...
             if (parametreQuant != null) {
                 if (   parametreQuant.m_bPresenceObligatoire
                    &&(parametreQuant.m_iTypePriseEnCompte != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART)  ) {
            ...
            if (sousTable != null) {
                ...
                while ( (!bFinEnumItems) && (enumItems.hasMoreElements()) ) {
                    ...
                    if (   parametreQual.m_bPresenceObligatoire
                         &&(parametreQual.m_iTypePriseEnCompte != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART)  ) {
                        m_tablePresenceObligatoire.put(sNomAttribut, Boolean.FALSE);
                        bFinEnumItems = true;
                    }
                }
        ...
        while ( ( (iNombreAttributsTotal<2) || (iNombreAttributsGauche<1) || (iNombreAttributsDroite<1) ) && (iIndiceColonne<iNombreColonnesPrisesEnCompte) ) {
            ...
            if (sNomColonne != null)
            {
                ...
                if (colonne.m_iTypeValeurs == DatabaseAdmin.TYPE_VALEURS_COLONNE_REEL) {
                    ...
                    if ( (iTypePosition==ContexteResolution.PRISE_EN_COMPTE_ITEM_DROITE) || (iTypePosition==ContexteResolution.PRISE_EN_COMPTE_ITEM_2_COTES) ) 
                        iNombreAttributsDroite++;
                    if ( (iTypePosition==ContexteResolution.PRISE_EN_COMPTE_ITEM_GAUCHE) || (iTypePosition==ContexteResolution.PRISE_EN_COMPTE_ITEM_DROITE) || (iTypePosition==ContexteResolution.PRISE_EN_COMPTE_ITEM_2_COTES) ) 
    ...
    public boolean EstItemSetValide(ItemSet itemSet) {
        ...
        while (item != null) {
            ...
            bItemSetValide = ( ObtenirTypePrisEnCompteItem(sNomAttribut, sNomItem) != ContexteResolution.PRISE_EN_COMPTE_ITEM_NULLE_PART );
    ...
    public boolean EstRegleValide(RegleAssociation regle) {
        ...
        while ( bRegleValide && (iEtapeTestRegle<2) ) {
            ...
            if (iEtapeTestRegle==0) {
                ...
                iTypeTestEtape = ContexteResolution.PRISE_EN_COMPTE_ITEM_GAUCHE;
            }
            else {
                iNombreItems = regle.m_iNombreItemsDroite;
                iTypeTestEtape = ContexteResolution.PRISE_EN_COMPTE_ITEM_DROITE;
            }
            ...
            while ( (bRegleValide) && (iIndiceItem<iNombreItems) ) {
                ...
                if (item == null)
                    ...
                    bRegleValide =    (iTypePosition == iTypeTestEtape)
                                   || (iTypePosition == ContexteResolution.PRISE_EN_COMPTE_ITEM_2_COTES);
