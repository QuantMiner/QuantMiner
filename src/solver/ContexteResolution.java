...
public class ContexteResolution {
    ...
    private ParametresPositionRegles m_positionnementRegles = null;
    private ParametresPositionRegles m_filtrageRegles = null;
    ...
    public ContexteResolution(FenetrePrincipale fenetreProprietaire) {
        ...
        m_filtrageRegles = new ParametresPositionRegles(this, ParametresPositionRegles.PARAMETRES_FILTRAGE_REGLES);
    ...
    public ParametresPositionRegles ObtenirInfosPostionnementRegles() { return m_positionnementRegles; }
    public ParametresPositionRegles ObtenirInfosPostionnementFiltrage() { return m_filtrageRegles; }
