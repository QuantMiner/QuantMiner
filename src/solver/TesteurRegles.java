...
public class TesteurRegles extends Thread { //test rules
    ...
    private OptimiseurRegle m_optimiseurCourant = null; // Object containing the method of optimizing rules
    ...
    public TesteurRegles(ContexteResolution contexteResolution, IndicateurCalculRegles indicateurCalcul) {
    ...
    public void DefinirOptimiseurRegle(OptimiseurRegle optimiseur) {
        if (optimiseur != null) {
